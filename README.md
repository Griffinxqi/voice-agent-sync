...
A real-time, voice-to-voice AI pipeline demo featuring a cutomer care assistant. Built with LangChain/LangGraph agents, AssemblyAI for speech-to-text, and Cartesia for text-to-speech.
